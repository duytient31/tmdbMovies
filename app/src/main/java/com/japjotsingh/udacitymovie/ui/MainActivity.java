...
import com.japjotsingh.udacitymovie.adapter.MovieAdapter;
import com.japjotsingh.udacitymovie.data.AppPreferences;
import com.japjotsingh.udacitymovie.databinding.ActivityMainBinding;
import com.japjotsingh.udacitymovie.model.Movie;
import com.japjotsingh.udacitymovie.utils.GridItemDecoration;
import com.japjotsingh.udacitymovie.utils.RecyclerViewScrollListener;
import com.japjotsingh.udacitymovie.viewmodel.MainViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void populateUI(int selected) {
        mViewModel.getudacitymovie().removeObservers(MainActivity.this);
        ...
        switch (selected) {
            case 0:
                mViewModel.getudacitymovie().observe(MainActivity.this,
